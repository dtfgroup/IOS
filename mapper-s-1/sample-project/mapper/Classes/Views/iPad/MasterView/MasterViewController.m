...
@synthesize masterTableView, toolbar, toolbarBottom, models, delegate, gradientView;
...
{ 
    ...
    UIImage* toolbarBgBottom = [[AppDelegate instance].colorSwitcher getImageWithName:@"ipad-tabbar-left"];
    ...
    UIImage *navBarImage = [[AppDelegate instance].colorSwitcher getImageWithName:@"ipad-menubar-left-7"];
    
    if([Utils isVersion6AndBelow]){
        navBarImage = [[AppDelegate instance].colorSwitcher getImageWithName:@"ipad-menubar-left"];
    }
